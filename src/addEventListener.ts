...
export default function (win: Window, catchErrorByCustomType: Function, sameOrigin: boolean, catchUnhandledRejection: boolean): void {
    ...
    if (catchUnhandledRejection) {
        ...
        const unhandledRejectionHandler = (ee: any) => {
